              ...
              <ul class="navbar-nav ">
                <li class="nav-item px-2">
                  ...
                  <li><div class="dropdown">
                      ...
                      <a href="/cart" class="nav-link text-white ">My Basket</a>
                </li>
              </ul>
             </div>
          ...
          <h2 class="basketTitle">Add Product</h2>
            <hr class="line-class">
              ...
              <div style="margin: auto; margin-left: 35%; width: 15%">
                ...
                <button type="buy" v-on:click="addProduct()"  class="btn-btn2 btn btn-success" style="width: 125%; margin-left: 40%;margin-top: 10%">Add Product</button>
              </div>
